...
[x] - **Task 1:** Connect the ingestion, DeBERTa encoder, and custom attention mechanisms into a unified inference pipeline.
[x] - **Task 2:** Format model outputs to yield hierarchical compliance matrices (number of flags, triggered text, ISO controls).
[x] - **Task 3:** Establish the Audit trail logging mechanism for explainability and non-repudiation of model decisions.
